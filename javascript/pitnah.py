def FakeReply(korban, pesan, chatId, MsgId, teks):
    return """var FakeReply  = async function (chatId, msgid, pesan, korban, MessagE){
    ...
    """%(chatId, MsgId, pesan, korban, teks)
def hidetag(chat_id, body, msg):
    return """var HideTagged = async function (ch, body,messagE) {
